...
<head>
    ...
    <title>{{ config('app.name', 'TradeVizta') }}</title>
    ...
    <script>
        (function() {
            ...
            if (t === 'light') {
                document.body && (document.body.className = 'font-body antialiased light');
            }
        })();
    </script>
...
<body class="font-body antialiased dark" x-data="{
    mobileNav: false,
    init() {
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4 lg:py-5 flex-wrap gap-3">
                ...
                <div class="flex items-center gap-2 sm:gap-3">
                    ...
                    <button @click="Livewire.dispatch('openAccountSettings')"
                        class="p-2 rounded-lg dark:hover:bg-white/5 hover:bg-black/5 transition-colors dark:text-[#8b8b93] text-[#6b6b70] hover:text-black dark:hover:text-white"
    ...
    <nav
        class="fixed bottom-0 inset-x-0 z-50 lg:hidden border-t backdrop-blur-xl safe-area-bottom
        ...
        <div class="flex items-stretch justify-around max-w-lg mx-auto">
            @php
                $bottomNavIcons = [
                    'dashboard' =>
                        '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0a1 1 0 01-1-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 01-1 1"/>',
                    'daily-log' =>
                    ...
                    'deposit-withdrawal' =>
                        '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V7m0 10v1m-4-5h8"/>',
                    'analytics' =>
            ...
            @foreach ($navItems as $item)
                ...
                <a href="{{ $href }}" wire:navigate
                   ...
                   {{ $isActive ? 'text-profit' : 'dark:text-[#8b8b93] text-[#6b6b70]' }}">
                    ...
                    <span
                        class="text-[9px] font-medium leading-tight truncate w-full text-center">{{ $item['label'] }}</span>
                </a>
            @endforeach
        </div>
    </nav>
